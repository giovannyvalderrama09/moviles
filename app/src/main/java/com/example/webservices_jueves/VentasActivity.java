...
public class VentasActivity extends AppCompatActivity implements Response.Listener<JSONObject>,Response.ErrorListener {
    ...
    private void eliminar_venta() {
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>()
                {
                    ...
                    public void onResponse(String response) {
                        //Limpiar_campos();
                        Toast.makeText(getApplicationContext(), "Registro de codigo venta eliminado correctamente!", Toast.LENGTH_LONG).show();
                    }
                },
                new Response.ErrorListener()
                {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(getApplicationContext(), "Error eliminando codigo!", Toast.LENGTH_LONG).show();
                    }
                }
        ) {
            @Override
    ...
    public void regresar_inicio() {
        Intent intmain=new Intent(getApplicationContext(),SesionFragment.class);
