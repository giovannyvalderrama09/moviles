...
public class UsuarioActivity extends AppCompatActivity implements Response.Listener<JSONObject>,Response.ErrorListener{
    ...
    private void registrar_usuario() {
        String url = "http://172.16.59.164:81/usuarios/registrocorreo.php";
    ...
    private void modificar_usuario() {
        String url = "http://172.16.59.164:81/usuarios/actualiza.php";
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>()
                {
                    @Override
    ...
    private void eliminar_usuario() {
        String url = "http://172.16.59.164:81/usuarios/elimina.php";
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>()
                {
                    @Override
    ...
    private void consultar_usuario(){
        if (jetusr.getText().toString().isEmpty()){
            ...
            String url = "http://172.16.59.164:81/usuarios/consulta.php?usr="+jetusr.getText().toString();
